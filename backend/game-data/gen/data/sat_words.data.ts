export default [
  ...
  },
  {
    ...
    "defs": [
      ...
      {
        "text": "to mark the outline of ",
        "samples": [
          "lights <i>delineating</i> the narrow streets"
        ]
      }
    ]
  },
  {
    ...
    "defs": [
      {
        "text": "to surrender often after negotiation of terms ",
        "samples": [
          "The enemy was forced to <bold>capitulate</bold> unconditionally."
        ]
      },
      {
  ...
  },
  {
    ...
    "defs": [
      {
        "text": "marked by or given to vehement insistent outcry",
        "samples": []
      }
    ]
  },
  ...
  },
  {
    ...
    "defs": [
      {
        "text": "a severe megaloblastic anemia that is marked by a progressive decrease in the number of red blood cells and by pallor, weakness, and gastrointestinal and nervous disturbances and is caused by malabsorption of vitamin B<sub>12</sub> due to the absence of intrinsic factor",
        "samples": []
      }
    ]
  },
  {
    ...
    "defs": [
      {
        "text": "dependent on chance circumstances, unknown conditions, or uncertain developments ",
        "samples": [
          "… forced to earn a <bold>precarious</bold> living as a door-to-door salesman.",
          "Their wealth was <bold>precarious</bold>, liable to be seized by the sultan if they fell from favour …",
          "… the resilience of our still-evolving planet, where life is always <bold>precarious</bold> but always tenacious."
        ]
      },
      {
        ...
        "samples": [
          ...
          "At 82 years old, she was in <bold>precarious</bold> health and had respiratory problems.",
          "… a downturn in food supply could tip a <bold>precarious</bold> balance.",
          "If the condition of the biosphere is even half as <bold>precarious</bold> as the environmentalists suggest, then the twenty-first century must, of necessity, abandon the theory of value so lovingly displayed in the windows of Bloomingdale's."
        ]
      },
      {
      ...
      {
        "text": "depending on the will or pleasure of another ",
        "samples": [
          "In rank and authority these officers seemed not inferior to the ancient proconsuls; but their station was dependent and <bold>precarious</bold>."
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    "defs": [
      {
        "text": "to relieve of a responsibility, obligation, or hardship",
        "samples": []
      },
      {
        "text": "to clear from accusation or blame",
        "samples": []
      }
    ]
  },
  {
    ...
    "defs": [
      {
        "text": "relating to matters of fact or practical affairs often to the exclusion of intellectual or artistic matters practical as opposed to idealistic ",
        "samples": [
          "a <bold>pragmatic</bold> leader",
          "a <bold>pragmatic</bold> {gloss}=practical{/gloss} approach to health care"
        ]
      },
      {
  ...
  {
    "word": "pragmatic sanction",
    "syllabic": "pragmatic sanction",
    "stems": [
      "pragmatic sanction",
      "pragmatic sanctions"
    ],
    ...
    "defs": [
      {
        "text": "a solemn decree of a sovereign on a matter of primary importance and with the force of fundamental law",
        "samples": []
      }
    ]
  },
  {
    ...
    "defs": [
      ...
      {
        "text": "a riddle whose answer is or involves a pun (as in \"Why didn't the lost hikers starve in the desert? Because of the <i>sand which is</i> there.\")",
        "samples": []
      }
    ]
  },
  ...
  },
  {
    ...
    "defs": [
      ...
      {
        "text": "marked by abundant inventiveness or productivity ",
        "samples": [
          "a <bold>prolific</bold> composer"
        ]
      }
    ]
  },
    ...
    "defs": [
      {
        ...
        "samples": [
          "<bold>ephemeral</bold> pleasures"
        ]
      },
      {
        "text": "lasting one day only ",
        "samples": [
          "an <bold>ephemeral</bold> fever"
        ]
      }
    ]
  },
